...
class StateManager:
    ...
    def __init__(self, db_path: str):
        # Usar MemorySaver en lugar de SqliteSaver
        # MemorySaver es más simple y funciona bien para prototipos
        self.checkpointer = MemorySaver()
        self.db_path = db_path
        logger.info("state_manager_initialized", checkpointer="memory")
    ...
    async def save_checkpoint(
        ...
        try:
            ...
            # MemorySaver no requiere await para put
