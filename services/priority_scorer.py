...
class PriorityScorer:
    ...
    async def _detect_critical_implications(self, message: str) -> Dict[str, float]:
        """Detectar implicaciones críticas usando GPT"""
        try:
...
Criterios:
- security: Fraude, acceso no autorizado, violación de seguridad
- financial: Disputas de pago, problemas de facturación, pérdidas monetarias
- legal: Copyright, contratos, violaciones legales
- operational: Lanzamientos bloqueados, servicios caídos, problemas técnicos críticos
